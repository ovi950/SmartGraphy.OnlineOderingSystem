<%@ Page MasterPageFile="~/UI/Backend/Site1.Master" Language="C#" AutoEventWireup="true" CodeBehind="ViewOrder.aspx.cs" Inherits="SmartGraphy.OnlineOderingSystem.UI.Backend.Supervisor.ViewOrder" %>
...
<asp:Content ID="content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <form runat="server">
        ...
        <input type="hidden" id="orderStatus" runat="server" />
        <h3>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                       <div class="row">
                           ...
                           <div class="col-lg-2"><label class="form-actions"><strong> Please provide a reason for reject</strong> </label></div>
                           
                       </div>
                        <div class="row">
                           <div class="col-lg-1"></div>
                           <div class="col-lg-2"><label class="form-actions"><textarea id="txtReason" class="form-actions"></textarea> </label></div>
                    ...
                    <div class="modal-footer">
                        ...
                        <asp:Button ID="btnAddCat" CssClass="btn light blue btn-outline" runat="server" OnClick="btnAddCat_Click" Text="Add" />
                        --%>
                        <button type="button" onclick="reject();" id="btnReason" class="btn blue btn-outline" data-dismiss="modal">Done!</button>
                    </div>
                </div>
            ...
            <div class="portlet light bordered">
                <div class="portlet-title">
                    ...
                    <div class="actions">
                        ...
                        <a data-toggle="modal" href="#modalRequirements" id="btnReason" class="btn default btn-lg">
                            Reject
                        </a>
                    </div>
...
<asp:Content ID="cont2" ContentPlaceHolderID="headContent" runat="server">
    <script type="text/javascript">
        $("document").ready(function () {
            var status = $("#<%=orderStatus.ClientID%>").val();
            if(status!="new"){
                $("#btnReason").hide();
                $("#btn_addnew").hide();
            }
            ...
            $.ajax(
        {
            ...
            data: JSON.stringify(param),
            dataType: "json",
            url: "../../../WebServices/BackendWebservice.asmx/RejrctOrder",
            success: function (result) {
